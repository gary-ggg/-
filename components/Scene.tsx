  ...
  return (
    ...
    >
      ...
      <OrbitControls 
        ...
        minDistance={10} 
        maxDistance={40} 
        autoRotate={appState === AppState.TREE_SHAPE && activeFrameId === null} // Stop rotation when frame active
        autoRotateSpeed={0.5}
        enableRotate={activeFrameId === null} // Disable rotation when frame active
        enableDamping={true}
        dampingFactor={0.05}
      />
      ...
      <group position={[0, -2, 0]}>
        ...
        {/* Render Transparent Foliage Last to ensure frames inside tree aren't occluded by z-write quirks */}
